...
import { Badge, CommandGroup, CommandItem } from "../../../../shared/view/ui";

/**
 * One branch of the model picker.
 *
 * `provider` is what selecting a model in it sets — it is not always the same
 * as the branch, because the Ollama branch is served by OpenCode.
 */
